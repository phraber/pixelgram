...
# AUTHOR: Will Fischer
# 
# This seems to yield trees that look more properly ladderized than the 
# ape::ladderize() version.  At least it agrees with the implementation
# provided in Andrew Rambaut's FigTree Java tree-rendering program.
